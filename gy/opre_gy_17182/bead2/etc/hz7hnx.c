...
int main()
{
    ...
    if (id1 > 0)
    {
        ...
        if (id2 == 0)
        {
            ...
            printf("Idomar - A sas felkeszitese a dronfogasra....(eves, ivas)! \n");
            sleep(2);
            ...
            for (j = 0; j < hossz; j++)
            {
                ...
                printf("Idomar - A befogasi ido=%i \n", ido);
                sleep(1);
...
{
    printf("NE-SAS-OLD KFT TESZTELESE \n");
    printf("\n");
    printf("\n");
    ...
    do
    {
        ...
        printf("Program tovabbi futasa -> 8 \n");
