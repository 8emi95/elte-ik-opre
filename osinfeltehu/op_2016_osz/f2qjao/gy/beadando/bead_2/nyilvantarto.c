    ...
    do {
        ...
        if(menu == 1) {
            ...
            if(rendezveny_struct.rendezvenyek_szama < 1000) {
				...
				sortores_poz_csere(rendezveny_struct.rendezvenyek[rendezveny_struct.rendezvenyek_szama].nev);

				printf("Helyszin: ");
                fgets(rendezveny_struct.rendezvenyek[rendezveny_struct.rendezvenyek_szama].hely, 100, stdin);
				sortores_poz_csere(rendezveny_struct.rendezvenyek[rendezveny_struct.rendezvenyek_szama].hely);
            ...
            printf("id\tNév\tHely\n");
            for(i = 0; i < rendezveny_struct.rendezvenyek_szama; i++) {
                printf("%d\t%s\t%s\n", rendezveny_struct.rendezvenyek[i].id, rendezveny_struct.rendezvenyek[i].nev, rendezveny_struct.rendezvenyek[i].hely);
            }
