...
int main(){
  ...
  struct student adam={"Barath Adam",2014}; // define a data structure to send
	...
	s_value_ptr.sival_ptr=&adam;  //rossz, mert a fork után lett definiálva az adam struct
	//s_value_ptr.sival_ptr=&who;  //ez és a zoli, csak akkor fog menni, ha a handler-ben a kikommentelt kódot vissza állítjuk és a jelenlegi printet kikommenteljük
	s_value_ptr.sival_int=10;
