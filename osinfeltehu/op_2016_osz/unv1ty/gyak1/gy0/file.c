...
#include <sys/stat.h>
#include <errno.h> //perror -> hibaüzenet, errno
#include <string.h>
...
int main(int argc,char** argv){
 ...
 f=open(argv[1],O_RDONLY); //file megnyitása olvasásra
 ...
 g=open(argv[2],O_WRONLY|O_CREAT|O_TRUNC,S_IRUSR|S_IWUSR); //O_TRUNC -> ha létezett töröljük; S_... jogosultságok
 ...
 char c;
 while (read(f,&c,sizeof(c))){ //sizeof azért kell, mert csak a címet látja a fv, hogy mennyit kell azt mi mondjuk meg
