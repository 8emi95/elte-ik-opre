...
int val, code;
//1. parameter: signal number
//2. parameter: signal information, practially one data is passed to handler:si_value
//3. parameter: info about process context, interrupted by signo signal: ucontext_t
...
struct mq_attr attr;
sigset_t set;
char *mqname = "/almafa1"; // mqname must start with / !!!!!
