...
{
 int l=0;
	 while (*str++)l++; //*str points to the next character
 return l;
}
int main()
{
  ...
  str2[0]='F'; //to write value character by character
  str2[1]='T';
  str2[2]='C';
  str2[3]=0; //at the end of a string there is a 0 character!
  printf("We've given value character by character -  str2: \'%s\'\n",str2); //new content
  
  strcpy(str2,"Hajrá Fradi!");   
