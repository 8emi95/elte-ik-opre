...
//itt meg lehet adni az uzenetek darabszamanak es meretenek maximumat
//szabalyozhatjuk h mennyi helyet foglaljon el az uzenetsor

//nevet adunk, ezzel ferunk hozza az uzenetroshoz
//	mq_open(mqname, ... , ... , tulajdonsagok )

//sigactionnel: adott jelzesre milyen jelzeskezelo fusson lehet

//fol kelljelentkezni az uzenetsorra
//ehhez be kell allitani a notify parametereket		mq_notify()
...
//ovatossagbol letrehozas elott toroljuk ha beragadt
...
if(pid == 0) // child
	...
	//hasonlo a poll() fvhivasos dologhoz
	//amig nem erkezett meg az adat az uzenetsorba, akkor addig mast is csinalhatunk
	//ez eroforrastakarekosabb mint a system5 os megoldas
