//ez kifinomulatabb a sigprocmaskban latot megoldasnal
//celja ugyanaz mint a sinal fv nek volt
//beallitja hogy hogy reagaljon a jelzesre az alkalmazasunk

//nem gyszeruenk egy handler fv adunk meg hanem 
//egy struktura tipusu valtozot (sigact)
//de ennek a strukturanak is lesz egy handler fv e
#include <stdlib.h>
#include <stdio.h>
#include <signal.h>
#include <sys/types.h>
...
int main(){
  ...
  {
    sigset_t sigset;
    //minden jelzes benne van a halmazba es most eldobaljuk amik nem kellenek
	//hogy ures v teli halmazzal indulunk: egyeni implementacios dontes
	sigfillset(&sigset);
    sigdelset(&sigset,SIGTERM);
    //ezzel a sigsuspend() el helyettesitjuk a pause() fvt
	//meg lehet adni hogy melyik jelzeseket blokkolja
	//az a jo benne hogy a blokkolas nem manualisan hanme automatikusan oldodik utana
	sigsuspend(&sigset);
