...
int main()
{
  ...
  //ez igy jelenleg sehova nem mutat a memoriaban
  char* str2; //it is a pointer variable (we have to allocate memory)
  
  //de igy mar ua mem teruletre mint str1
  ...
  //foglalnunk kell neki memoriat 		(char*) elejen tipuskenyszerites
  //ezzel lesz helyem 80 karakter szamara
