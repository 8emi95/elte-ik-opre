...
int main(){
 ...
 //alarm(1); //it is implemented in POSIX systems - but it is adviced to use setitimer; csak egyet küld másodpercben
...
///2. trial of creating a timer by setitimer function
 ...
 setitimer(ITIMER_REAL,&timer,NULL ); //result = 0, if it is good , periodikusan küld ezredmásodpercben -> pontosabb
