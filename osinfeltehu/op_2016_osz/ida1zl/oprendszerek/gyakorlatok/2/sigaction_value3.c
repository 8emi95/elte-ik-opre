...
struct student
{
  ...
  timer_t t_id;
// signal handler 
void handler(int signumber,siginfo_t* info,void* nonused)	//1. param: milyen jelzés érkezett, 2. param: mutató structra, amibe az oprendszer elhelyezi azokat az adatkat amihez hozzá tudunk férni, 3.param:még nem használt
{
...
int main(){
 ...
 // struct student adam={"Barath Adam",2014}; // define a data structure to send
	...
	//s_value_ptr.sival_ptr=&adam;		nem megy át a név és az évszám, mert ez a child folyamatban van
