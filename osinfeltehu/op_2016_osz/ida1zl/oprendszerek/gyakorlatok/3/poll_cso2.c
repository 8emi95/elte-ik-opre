...
int main(){
 ...
 struct pollfd poll_fds[5]; // poll file descriptor array, 5csővezeték
 ...
 //------------------------------------------------------
 //első rész
 int result=poll(poll_fds,1,1000); //meddig nem kell futási jogot adni a csővezetéknek 1000 = 10mp
 ...
 if (child>0)
  ...
  { 
   ...
   {
   printf("Now we can read from the pipe \n"); //addig nem jelenhet meg amíg a szülő nem írt valamit a csőbe
   int data; char cdata;
