...
//amíg a szülõ nem engedi fel a szemafort, a gyerek nem fér hozzá
int main (int argc,char* argv[]) {
	...
	printf("Szulo, szemafor up!\n");
       	sem_post(semid);	// semaphore up, felengedés, innentõl a gyerek is tudja használni
	shmdt(s);	// release shared memory	
       	wait(NULL);       
       	szemafor_torles(sem_nev);//akkor lehet törölni ha mindenki lezárta
