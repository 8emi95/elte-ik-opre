...
node_t* find_visitor_by_event_id(node_t **head, unsigned event_id) {
...
int delete_visitor(node_t **head, unsigned event_id) {
...
void delete_visitor_all(node_t **head, unsigned event_id) {
