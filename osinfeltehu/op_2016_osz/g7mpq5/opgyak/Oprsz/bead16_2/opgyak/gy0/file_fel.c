...
struct Pers {
 char name[128]; // TODO mi lesy, ha char <F3><F4>ot akarok hasynalni, hf
 int id;
};
...
int main(int argc,char** argv){
 ...
 g=open("proba",O_WRONLY|O_CREAT|O_TRUNC,S_IRUSR|S_IWUSR);
