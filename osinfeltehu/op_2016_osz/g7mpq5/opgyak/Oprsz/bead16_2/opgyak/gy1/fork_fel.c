...
// hf ket gyereket letrehozni
// hf 3-4, n db gyereket, valtozo gyerek szam
 ...
 *notacommonvalue = 1;
 ...
 if (child<0){perror("The fork calling was not succesful\n"); exit(1);}  // shell szinten az 1 a hamis, 0 az igaz, exit a shellnek adja vissza
