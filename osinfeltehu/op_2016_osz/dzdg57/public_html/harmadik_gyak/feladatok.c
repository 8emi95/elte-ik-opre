...
4. Inditsunk egy programbol pontosan 3 folyamatot, es adjunk nekik kulonbozo feladatokat! Az egyik hozzon letre egy fajlt, masik torolje (akar letezik akar nem), harmadik pedig listazza ki az aktualis konyvtar tartalmat. (Segitsegnek linux parancsok: "touch file", "rm file" "ls -la .i") 
