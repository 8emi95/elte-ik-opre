...
{
  /*
  Nevesített csovezetéket nem lehet kétszer létrehozni
  */
    int pid,fd;
    printf("Fifo start!\n");
    ...
    pid = fork(); //létrehozza a szülő meg a gyerek folyamatot
    //Ez a két folyamat fog kommunikálni a csővezetéken keresztül
	...
	close(fd);
	// remove fifo.ftc
  //megszünteti a névlegesítést FONTOS különben nem fut le újra 
  unlink("fifo.ftc");
        }
	else // child
	{
