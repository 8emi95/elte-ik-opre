...
//Egy saját hossz függvény megvalósítása strlen lenne a normál, gyári
int length(char * str)
{
 int l=0;
 //először a mutatót lépteti, aztán összehasonlít, majd a mutató értékét móddosítja
...
int main()
{
  ...
  //lefoglal memóriát elemszám * elem mérete, malloc egy mutató, aminek nincs típusa 
  ...
  //C ben a szövegek végét egy 0 karakter jelzi (különben a memóriaszemét jön!)
