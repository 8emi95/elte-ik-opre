...
void createEvent(Event** pofevents, size_t* eventSize)
{
	...
	printf("Kerem adja meg rezdezveny azonositojat es nevet:  Forma: [ azonosito(egesz szam) nev ]!\n");
...
void signCandidate(Candidate** pofcandidates, size_t* candidatesSize)
{
	...
	printf("Kerem adja meg a nevet, email cimet, rendezveny azonositojat: Forma: [ nev email rendezvenyazononsito ]!\n");
