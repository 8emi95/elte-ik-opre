...
int main (int argc,char* argv[]) {
	...
	// legenerált egyedi kulcsot készít egy létező fájl nevéből!!!
    kulcs=ftok(argv[0],1);
    // osztott memoria letrehozasa, irasra olvasasra, 500 bajt mrettel
	// IPC_CREAT: ha eddig még nem volt létrehozva akkor hozd létre egyébként kapcsolódj rá
    ...
    if(pid>0){    
       ...
       char buffer[] = "A labad is szagolhatnad! \n";                   
       // beirunk a memoriaba 
       strcpy(s,buffer);
...
//	s[0]='B';  //ez segmentation fault hibat ad
	...
	// CSAK akkor lehet törölni ha mindenki elengedi,
	// Ha nem töröljük akkor az ipcs paranccsal lehet törölni.
