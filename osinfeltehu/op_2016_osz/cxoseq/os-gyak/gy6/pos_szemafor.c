...
// A másikhoz képest annyi a különbség hogy nem családot hoz létre hanem 1 szemafort használ.
// fordításhoz gcc -pthread
sem_t* szemafor_letrehozas(char*nev,int szemafor_ertek)
{
	// nem lehet úgy létrehozni hogy ne adnánk meg a kezdõ értéket.
	// a másik esetben erre egy új hívás kell.
...
int main (int argc,char* argv[]) {
	...
	{    
		...
		//nincs struct beállítás hogy melyik semaphore-t kell módosítani.
	...
	{	
		...
		// arra várakozik, hogy leengedhesse a semaphore -t
