...
struct student
{
  ...
  /*********************
	...
	fordításhoz már használni kell a -lrt kapcsolót
  */
  
  struct student who={"Who am i?",2014}; // define a data structure to send
  timer_t t_id;
// signal handler 
// (jelzés, struct-ra mutató mutató, ...)
...
int main(){
  ...
  else 
  {
	...
	// melyik pidnek milyen jelzést milyen értéket akarok még adni (itt most egész vagy mutató)
