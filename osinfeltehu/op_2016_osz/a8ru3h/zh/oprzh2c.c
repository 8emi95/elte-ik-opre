...
void szerelveny(int uzenetsor, pid_t uzemelteto) {
	...
	//menetidok[hanyadik_vagyok-1] = menetido;
	sleep(1);
...
int main (int argc, char* argv[]) { 
	...
	menetidok = shmat(oszt_mem_id,NULL,0);
	...
	int ossz_menetido = 0;
	for (i=0; i<szerelvenyek_szama; i++) {
		ossz_menetido = menetidok[i];
	}
	printf("Átlagos menetidő: %d\n", ossz_menetido/szerelvenyek_szama);
