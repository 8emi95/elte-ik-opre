...
int main(int argc, char* argv[])
{
	...
	printf("Csonyitas eredmenye: %d!\n",fid);
        ...
        // folyamatoknak maguknak kell megnyitni a fájlt, a megnyitásnál várakoznak,
        //ha a fájl nincs megnyitva „minkét irányba” (read, writ e).
        //!!!! wait 
