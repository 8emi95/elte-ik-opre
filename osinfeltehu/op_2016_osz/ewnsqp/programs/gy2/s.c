...
// 31 különböző jelzés van
// default dolog, hogy ha valaki megkap egy ilyen jelet, az leáll, de ez felülbírálható
// egyik: figyelmenkívül hagyjuk a jelzést
// másik: handlert csatolunk hozzá

// ctrl+c is egy ilyen signal
// kill -SIGTERM <pid>
// ./a.out &  - háttérben fut a program
// kill -SIGKILL <pid>	// nem lehet figyelmenkívül hagyni
