...
//Az előző beadandót kiegészítettem egy LeadEvent() eljárással ami levezényli a soron következő eseményt.
//A LeadEvent()-ben egy két helyre tettem Sleep()-et hogy ne olyan gyorsan írjon a képernyőre 
//így jobban nyomonkövethető a program működése.
struct Guest{
    char name[100];
    char email[100];
    time_t tm;
