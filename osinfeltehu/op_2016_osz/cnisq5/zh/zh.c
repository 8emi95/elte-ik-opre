...
int main(int argc, char* argv[])
{
	...
	else //child
	{
		...
		if (success != 5)
		{
			printf("En a %d .szerelveny vagyok es utana %d szerelveny van meg es sikerrel teljesitettem.\n", mes.index, mes.sum-mes.index);
			strcpy(mes.text,"Jo");
		}
		else
		{
			printf("En a %d .szerelveny vagyok es utana %d szerelveny van meg es nem sikerult teljesitenem.\n", mes.index, mes.sum-mes.index);
