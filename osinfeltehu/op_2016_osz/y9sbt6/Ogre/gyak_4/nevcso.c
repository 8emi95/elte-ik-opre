...
int main(int argc, char* argv[])
{
	...
	close(fd);
	// remove fifo.ftc
	unlink("fifo.ftc"); // törlésről nekünk kell gondoskodni, ha elfelejtük és újra elindítjuk a programot, akkor már nem tudja létrehozni a csövet, mert már létezik
        }
	else // child
	{
