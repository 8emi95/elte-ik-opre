...
void handler(int signumber){
  ...
  //signal(SIGTERM, SIG_DFL); // meg fog állni a folyamat
  //raise(signumber); // lő saját magának újra egy sigterm jelzést, amellyel leáll a program
  //++i;
}
...
int main(){
  ...
  else 
  {
    ...
    pause();
    /*while (i == 0) // az i-t a handler fogja megváltoztani
    {
      sleep(100); // nem illik üres ciklust hagyni
    }*/
