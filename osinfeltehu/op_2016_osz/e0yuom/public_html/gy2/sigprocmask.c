...
int main(){
  ...
  //jelzés nélküli halmaz
  sigaddset(&sigset,SIGTERM); //SIGTERM is in set
  //hozzáadja a halmazhoz a sigterm jezlést
  //sigfillset(&sigset); //each signal is in the set
  sigprocmask(SIG_BLOCK,&sigset,NULL);
//blokkolást végzi el  amásodik paraméter az amelyik jelzéseket blokkkolni akarjuk
  //signals in sigset will be blocked
