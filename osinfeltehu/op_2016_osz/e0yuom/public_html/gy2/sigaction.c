...
int main(){
  ...
  //milyen jelzéseket szeretnék blokkolni reagálni rá
  ...
  {
    sigset_t sigset;
    sigfillset(&sigset); // itt a teli halmazból dobálja el ami nem kell (záróljelben ami kell)
...
// fordított sorrendbe fog megérkezni a jezlés mert blokkoljuk az elsőt