...
//feladat: a gyerek folyamat IS kapjon egy signalt a szülő folyamattól
...
int main(){
  ...
  pid_t child=fork(); //child változóban benne van a gyerek folyamat pidszáma
  if (child>0)
  { 
    pause(); //waits till a signal arrive 
	sleep(3);
	kill(child,SIGTERM); //felhasználom a child változót a gyerek folyamat pidszámához
