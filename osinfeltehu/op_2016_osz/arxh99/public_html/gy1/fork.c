...
int main()
{
 ...
 {
    waitpid(child,&status,0); //status ellenõrzés, nem megfelelõen lett leállítva a gyerek. ezt mindig a szõben kell elhelyezni, a gyerek folyamatba ne várjunk a gyerekre
