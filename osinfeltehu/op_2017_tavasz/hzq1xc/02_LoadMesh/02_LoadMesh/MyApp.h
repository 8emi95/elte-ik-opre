...
protected:
	...
	GLuint m_waterTextureID3; // fájlból betöltött textúra azonosítója
	GLuint m_waterTextureID4; // fájlból betöltött textúra azonosítója
	GLuint m_waterTextureID5; // fájlból betöltött textúra azonosítója
