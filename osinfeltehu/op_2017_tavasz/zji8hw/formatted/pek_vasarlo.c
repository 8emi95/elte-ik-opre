...
// posix semaphore requires to link: cc -lrt pek_vasarlo.c
...
void pek()
{
    ...
    while (s[1])
    {
        ...
        sem_post(tele);
        li = random();
        usleep(li % 100000);    // wait 0-100000 microseconds
...
void vasarlo()
{
    ...
    while (s[1])
    {
        ...
        sem_post(ures);
        li = random();
        usleep(li % 100000);    // wait for a while, 0-100000 microseconds
