...
int main(){
  ...
  //3.paraméter, ha van valahol beállítva egy jelzéshalmaz, és én ahelyett egy másiakt akarok, akkor a régit engedi kitölteni egy változóba, hogy ne kelljen ujra és ujra ezeket a beállításokat végrehajtani
  //0 esetén jó a régi, de ha másikat akarunk, akkor bele tudnánk menteni egy sigterm típusú változóba  
  ...
  if (child>0)
  {
    ...
    sigprocmask(SIG_UNBLOCK,&sigset,NULL);    //feloldja a blokkolást
