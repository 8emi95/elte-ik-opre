...
/*
Waits 3 seconds, then send a SIGTERM 15 signal (it is blocked)
Waits 3 seconds, then send a SIGUSR1 10 signal (it is not blocked)
Child process ended
Signal with number 10 has arrived
The blocking of SIGTERM 15 signal is released, so the formerly sent SIGTERM signal arrives
