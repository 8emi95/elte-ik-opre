...
//Accepts SIGUSR1
	...
	else
	{
		...
		printf("taxi read from message queue: %s\n", message);
		char taxi_meesage[] = "Taxi started\0";
		send_message(messageq_id, 4, taxi_meesage);
