...
int main()
{
    ...
    //      short poll_fds - revents returned occured events
    // 2. parameter - nfds_t type, number of wathing file descriptors
    // 3. parameter - time in milliseconds, if this parameter is negative, it means an infinite timeout
    ...
    { // parent process
        ...
        sleep(3);
        printf("Parent writes a number to the pipe!\n");
