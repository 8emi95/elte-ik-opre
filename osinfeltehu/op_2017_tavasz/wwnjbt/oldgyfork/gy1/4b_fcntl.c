...
int main(){
	...
	/************************************************/
	struct flock lock_data;	// milyen lockot akarok gyártani a fájlra
	// lock_data.l_pid; // processid
	// lock_data.l_type; //F_WRLCK, F_RDLCK, F_UNLCK
	
	//lock_data.l_whence; // melyik területre szeretnék lockolni, byte intervallum
	lock_data.l_whence = SEEK_SET;	//the absolute starting position of locking: 
	//		SEEK_SET - start of file, 
	//		SEEK_END - end of file, 
	//		SEEK_CUR - actual place of file
	lock_data.l_start = 0; 	// relative position of locking to l_whence
	lock_data.l_len = 0; 	// (from l_start)how long is the locked part of the file, 0 - if it depends on the whole file
	/************************************************/
