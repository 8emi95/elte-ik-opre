...
void printOutQuestionsFormatted()
{
    ...
    for(i = 0; i < qIndex; ++i)
    {
        ...
        printf("  Vegleges: "); q[i].isPermanent ? printf("igen") : printf("nem");
...
//            q[i].isPermanent = req[i];
        ...
        // veglegesites = ami kell azt kiirom fajlba.
        // amire szukseg van, azt a req tomb mutatja
