...
int szemafor_letrehozas(const char* pathname,int szemafor_ertek){
	...
	/* Kulcsgenerálás, majd az egyetlen szemafort tartalmazó
	szemaforkészlet létrehozása: */  
...
void szemafor_muvelet(int semid, int op){
    ...
    muvelet.sem_flg = 0;	// ha NO_WAIT lenne és nem a szülõ kezdene, akkor gond lenne
