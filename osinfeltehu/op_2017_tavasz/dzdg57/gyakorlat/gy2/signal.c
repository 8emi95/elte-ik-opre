...
int main(){
  ...
  else 
  {
	...
	// azért is raktuk ide a sleep-et, mert veszélyes a szülőben lévő pause(), mert ha a gyerek hamarabb elküldi a jelzést,
	// mint a szülő a pause()-hoz ért, akkor a szülő beragad (,mivel várakozik egy szignálra, de az meg nem jön)
    sleep(3);
