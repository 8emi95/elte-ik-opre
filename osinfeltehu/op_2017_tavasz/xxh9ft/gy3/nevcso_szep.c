...
int main(int argc, char* argv[])
{
    ...
    if(pid>0)   //parent
	{
        ...
        close(fd);
        // remove fifo.ftc
        unlink("fifo.ftc"); // ha kimarad, a program második futtatásánál nem tudja létrehozni a csövet, mert már létezik. Akár az elejére is lehet tenni, hogy ott biztos töröljön egyet, ha esetleg van.
    }
	else // child
	{
        ...
        write(fd,"Hajra Fradi!\n", 13); // nem 12, hogy beírja a végén a sztirng vége nullát is.
        close(fd);
