...
void sig_h(int sing_number) {
	//printf("SIGH with number %i has arrived\n", sing_number);
}
...
int main(int argc, char* argv[])
{
    ...
    else
    {
		...
		{
			send_msg(message, "Feltettem egy kerdest");
