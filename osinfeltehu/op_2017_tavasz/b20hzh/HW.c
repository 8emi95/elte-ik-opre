...
void mainLoop(){
    ...
    while (quit != true){
        ...
        switch  (userInput) {
            ...
            case ('x'): //TODO Maybe don't have case and put at the end of switch case
                quit = true;
                printf("\n\n Have a good day! \n\n");
...
int mainMenuSelection(){
    ...
    printf("\n\n Please choose one of these Options : "
                   ...
                   "\n  Press 'b' to List the questions and answers"
                   "\n  Press 'c' to Edit"
                   "\n  Press 'd' to Delete a question"
                   "\n  Press 'f' to Export survey"
                   "\n  Press 'x' to quit"
                   "\n\n  Option: "
                   "");
    int c = getchar();
...
void addQuestion(){
    ...
    printf("You're option is \"Add a Question\""
    ...
    printf("\n\n ADDING YOUR QUESTION IS COMPLETED !! \n\n");
...
void listQuestions(){
    if(Number_of_Questions != 0) {
        ...
        printf("\n\n\n THESE ARE ALLL THE QUESTIONS WE HAVE IN OUR DATABASE  \n");
...
void editQuestion(){
    if (Number_of_Questions != 0) {
        ...
        printf("you choose this question to edit: %d", numberToEdit);


        printf("\nTo Edit the Question press q"
               "\nTo Edit Answer a press a"
               "\nTo Edit Answer b press b"
               "\nTo Edit Answer c press c"
               "\nTo Edit Answer d press d: ");


        fseek(stdin, 0, SEEK_END);
        int editParam = getchar();

        printf("\n\n Please enter modification here: ");
    ...
    } else printf("\n\n THERE IS NO QUESTION IN THE DATABASE TO MODIFY YET"
...
void deleteQuestion(){
    ...
    printf("\nYou're option is \"Delete Question\""
...
void exportSurvey(){
    ...
    printf("\n EXPORTING TO FILE WAS SUCCESSFUL \n\n");
