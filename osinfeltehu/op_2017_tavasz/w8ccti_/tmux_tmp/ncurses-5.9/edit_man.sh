...
TERMINFO="/home/op/w8ccti/local/share/terminfo"
...
*.[0-9]*)
	...
	if test ! -f /home/op/w8ccti/tmux_tmp/ncurses-5.9/man_alias.sed ; then
cat >>/home/op/w8ccti/tmux_tmp/ncurses-5.9/man_alias.sed <<-CF_EOF2
		s,@DATADIR@,$datadir,g
...
s,@TSET@,tset,g
CF_EOF2
		echo "...made /home/op/w8ccti/tmux_tmp/ncurses-5.9/man_alias.sed"
	fi
	...
	aliases=`sed -f $top_srcdir/man/manlinks.sed $inalias |sed -f /home/op/w8ccti/tmux_tmp/ncurses-5.9/man_alias.sed | sort -u`
	...
	sed	-f /home/op/w8ccti/tmux_tmp/ncurses-5.9/man_alias.sed \
		< $i >$TMP
