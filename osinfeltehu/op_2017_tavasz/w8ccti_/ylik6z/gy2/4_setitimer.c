...
/*
The program was alarmed by alarm function

The program was alarmed by setitimer the 1. time
        Timer will be expired after 2 seconds
        Timer will be expired after 1 seconds
        Timer will be expired after 0 seconds
The program was alarmed by setitimer the 2. time
        Timer will be expired after 2 seconds
        Timer will be expired after 1 seconds
        Timer will be expired after 0 seconds
The program was alarmed by setitimer the 3. time
        Timer will be expired after 2 seconds
        Timer will be expired after 1 seconds
        Timer will be expired after 0 seconds
The program was alarmed by setitimer the 4. time
        Timer will be expired after 2 seconds
        Timer will be expired after 1 seconds
        Timer will be expired after 0 seconds
The program was alarmed by setitimer the 5. time
Terminated
*/