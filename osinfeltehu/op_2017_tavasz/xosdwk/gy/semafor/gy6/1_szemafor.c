...
void szemafor_muvelet(int semid, int op) {
    ...
    muvelet.sem_flg = 0;
	/* A semop függvény megkísérli hozzáadni a szemaforhoz sem_op értékét, 
		blokkolja a folyamatot, ha az eredmény negatív lenne: */ 
...
Szulo indul, kozos memoriaba irja: I like Illes (Pop group:)!

Gyerek: Indula szemafor down!
Szulo, szemafor up!
Gyerek, down rendben, eredmeny: I like Illes (Pop group:)!
