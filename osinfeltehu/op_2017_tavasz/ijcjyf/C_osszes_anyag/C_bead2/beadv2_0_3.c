						...
						while ((bytes_read = read(fh, &t, 1)) > 0) {
							...
							if (t=='\n'){
								...
								if (buffer[0]=='K'){
									 ...
									 strcpy( veglegesKerdesek[veglegesKerdesekSzama].kerdes, buffer);
									 veglegesKerdesek[veglegesKerdesekSzama].valaszokSzama=0;
									// strcpy( osszesKerdes[aktualisKerdes].valasz1, sorBuffer);//??
								}else if(buffer[0]=='V'){
									...
									case ('1'):
									 strcpy( veglegesKerdesek[veglegesKerdesekSzama].valasz1, buffer);
									 veglegesKerdesek[veglegesKerdesekSzama].valaszokSzama++;
									 break;
									
									case ('2'):
									 strcpy( veglegesKerdesek[veglegesKerdesekSzama].valasz2, buffer);
									 veglegesKerdesek[veglegesKerdesekSzama].valaszokSzama++;
									break;
									
									case ('3'):
									 strcpy( veglegesKerdesek[veglegesKerdesekSzama].valasz3, buffer);
									 veglegesKerdesek[veglegesKerdesekSzama].valaszokSzama++;
									break;
									
									case ('4'):
									strcpy( veglegesKerdesek[veglegesKerdesekSzama].valasz4, buffer);
									veglegesKerdesek[veglegesKerdesekSzama].valaszokSzama++;
									break;
								 ...
								 strcpy( veglegesKerdesek[veglegesKerdesekSzama].datum, buffer);
	   ...
	   {		   
	       sleep(3);	// sleeping a few seconds, not necessary
			  ...
			  sleep(3);
				...
				write(pipeBackfd[1], & kapottKerdes1 ,sizeof(kapottKerdes1));
			    write(pipeBackfd[1], & kapottKerdes2 ,sizeof(kapottKerdes2));
			    write(pipeBackfd[1], & kapottKerdes3 ,sizeof(kapottKerdes3));
           ...
           {    // szulo process 
			   ...
			   close(pipeBackfd[1]);
			   read(pipeBackfd[0], &  veglegesKerdesek[0] ,sizeof( veglegesKerdesek[0]));
			   read(pipeBackfd[0], & veglegesKerdesek[1] ,sizeof(veglegesKerdesek[1]));
			   read(pipeBackfd[0], &  veglegesKerdesek[2] ,sizeof( veglegesKerdesek[2]));
			 //  wait();
