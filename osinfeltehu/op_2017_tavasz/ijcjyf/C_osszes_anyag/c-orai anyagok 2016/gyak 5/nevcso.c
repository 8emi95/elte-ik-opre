...
int main(int argc, char* argv[])
{
	...
	close(fd);
	// remove fifo.ftc
	unlink("fifo.ftc"); //!!!!!!!!!! elsőnek müxik, másodszorra nem. mivel ott 
						//maradt a nevesített csővezeték, de másodszorra nem tudja létrehozni
						// ls -al  parancsal ki lehet listázni 
						// de vigyázni , a csövezeték méretét nem mutatja, 0- látunk az ls paranccsal.
        }
	else // child
	{
