...
int main (int argc,char* argv[]) {
 ...
 s = shmat(oszt_mem_id,NULL,0);// rakpcsolodas
    //
    pid = fork();
    if(pid>0){    
...
//	s[0]='B';  //ez segmentation fault hibat ad
	...
	if ( pid == 0 ) 
	{
	sleep(1);	  //kis csalás h várjunk az osztott memoriára h beleirjanak  megoldas:6.gyak
