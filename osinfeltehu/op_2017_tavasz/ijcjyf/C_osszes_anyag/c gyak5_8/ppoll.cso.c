...
//33-34 helyett a felette lévő kettő van kikommentezve: igy is ugyis tovább lép  v szignál miatt, v irás miatt 
// ha 31-34 ig van kikommentelve, akkor az időtúllépés miatt lép tovább
