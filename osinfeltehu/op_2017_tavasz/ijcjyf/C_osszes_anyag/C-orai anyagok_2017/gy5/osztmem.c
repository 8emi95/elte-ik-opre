...
int main (int argc,char* argv[]) {
    ...
    oszt_mem_id=shmget(kulcs,500,IPC_CREAT|S_IRUSR|S_IWUSR); // iras olvasas jog
 ...
 s = shmat(oszt_mem_id,NULL,0); // itt mint karakter többként használjuk, de lehetne más mutató is
    //
    pid = fork();
    if(pid>0){    
