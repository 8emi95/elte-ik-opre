					...
					i =1;
						 ...
						 strcpy( osszesKerdes[ujkerdes].valasz2, buffer[2]);
						  ...
						  strcpy(osszesKerdes[ujkerdes].valasz4, buffer[5]);
					   	 ...
					   	 if (valaszokSzama>=3) {strcpy(osszesKerdes[ujkerdes].valasz3, buffer[3]);   prepend(osszesKerdes[ujkerdes].valasz3, '3'); prepend(osszesKerdes[ujkerdes].valasz3, 'V');}
						 if (valaszokSzama==4) {strcpy(osszesKerdes[ujkerdes].valasz4, buffer[4]);   prepend(osszesKerdes[ujkerdes].valasz4, '4'); prepend(osszesKerdes[ujkerdes].valasz4, 'V');}
