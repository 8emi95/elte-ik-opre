...
int main(){
  ...
  struct student adam={"Barath Adam",2014}; // define a data structure to send
	...
	//zoli heyére beírhatunk adam-ot is. Ekkor az nem megy át, mert a zoli a fork előtt volt deklarálva, az adam pedig utána -> az csak a gyerek munkaterületén látszódik
