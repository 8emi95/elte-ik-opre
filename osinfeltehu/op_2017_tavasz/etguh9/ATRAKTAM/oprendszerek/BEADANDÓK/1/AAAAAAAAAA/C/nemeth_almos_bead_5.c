		...
		if (change > 0)
		{
			...
			else if (c == '2')
			{
				...
				if (c == '1')
				{
					...
					if (change_ans > 0)
					{
						printf("Korabbi verzio: %s\n", questions[change].answers[change_ans-1]);
						printf("Kerdes szovege (max %i karakter): ", MAX_ANSWER_SIZE);
					    read_String(questions[change].answers[change_ans-1], MAX_ANSWER_SIZE);
		    			printf("Modositott:  %s\n\n", questions[change].answers[change_ans-1]);
					}
				}
				else if (c == '2')
				...
				else if (c == '3')
				{
					if (questions[change].answers_Count > 2)
					{
						...
						printf("\nAdja meg a modositando valasz sorszamat (ha megsem kivan valaszt torolni, irjon be 0-t): ");
						int del_ans;
						scanf("%d", &del_ans);
						...
						if (del_ans > 0)
						{
							--questions[change].answers_Count;
							int i;
							for (i = del_ans-1; i < questions[change].answers_Count; ++i)
							{
