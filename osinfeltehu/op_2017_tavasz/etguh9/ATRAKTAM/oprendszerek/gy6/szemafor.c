...
int main (int argc,char* argv[]) {
    ...
    kulcs=ftok(argv[0],1);
    sh_mem_id=shmget(kulcs,MEMSIZE,IPC_CREAT|S_IRUSR|S_IWUSR);  //kulcs helyett lehet IPC_CREAT
...
//
	...
	printf("Gyerek: Indul a szemafor down!\n");
       szemafor_muvelet(semid,-1); // down, wait if necessary  //lezárja saját magának a szemafort
